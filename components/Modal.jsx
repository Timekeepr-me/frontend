      ...
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="flex flex-col justify-center items-center relative w-1/4 my-6 mx-auto max-w-md p-3 bg-[#2a2a2a] text-white rounded-xl border border-secondary shadow-2xl h-2/5">
              {/*title*/}
              ...
              >
                <Button text="submit" click={handleCloseModal} />
              </div>
            </div>
          </div>
